...
;layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    F.prototype.config = {
        ...
        //code by yzy
        let str = this.config.response.dataName.split('.');
        if(str.length>1){
            let temp = null;
        ...
        return c.key = s.id || s.index, d.cache[c.key] = u, c.layPage[0 == o || 0 === (u instanceof Array ? u.length : 0) && 1 == n ? "addClass" : "removeClass"](y), r ? m() : 0 === (u instanceof Array ? u.length : 0) ? (c.renderForm(), c.layFixed.remove(), c.layMain.find("tbody").html(""), c.layMain.find("." + f).remove(), c.layMain.append('<div class="' + f + '">' + s.text.none + "</div>")) : (m(), c.renderTotal(u), void(s.page && (s.page = t.extend({
